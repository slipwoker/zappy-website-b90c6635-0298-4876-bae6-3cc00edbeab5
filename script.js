document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatedElements.length > 0) {
    ...
    const revealElement = function (el) {
      el.style.opacity = '1';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קבוצת דירותיים בע״מ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b90c6635-0298-4876-bae6-3cc00edbeab5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b90c6635-0298-4876-bae6-3cc00edbeab5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b90c6635-0298-4876-bae6-3cc00edbeab5';
